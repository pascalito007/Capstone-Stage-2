...
public class MainFragmentAdapter extends RecyclerView.Adapter<MainFragmentAdapter.PodcastViewHolder> {
    Cursor cursor;

    public PodcastClickListener mOnClickListener;

    public MainFragmentAdapter(PodcastClickListener mOnClickListener) {
