...
public class MainCategory2FragmentAdapter extends RecyclerView.Adapter<MainCategory2FragmentAdapter.PodcastViewHolder> {
    Cursor cursor;

    public PodcastClickListener mOnClickListener;

    public MainCategory2FragmentAdapter(PodcastClickListener mOnClickListener) {
    ...
    public class PodcastViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            mOnClickListener.onCategory2ItemClick(Podcast.getPodcastFromCursor(cursor),view);
        }
    }

    public interface PodcastClickListener {
        void onCategory2ItemClick(Podcast podcast,View view);
    }
}
